                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h2> <small>Forget password</small></h2>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                                    ...
                                    <p><span id="lblWelcomeICTuser"><p style='font-family: courier; color: red;'>[Enter your password]</p></span></p>
                        		</div>
                            ...
                            <div class="form-bottom">
									...
									<div class="form-group">
									 ...
									 <div class="form-group">
			                        	<label class="sr-only" for="form-password">Re-type your Password</label>
                                        <input name="txtPassword" type="password" id="txtPassword" placeholder="Re-type your Password..." class="form-username form-control" required="" />
			                        </div>
