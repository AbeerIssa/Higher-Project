...
<body>
    <form method="post" action="insertevent.php" id="form1">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
							...
							<div class="form-group">
									...
									<div class="form-group">
                                        ...
                                        <input name="Fest_name" type="text" id="txtFest_name" placeholder="Fest name" class="form-username form-control" required="" />
			                        </div>
<div class="form-group">
										<label class="sr-only" for="form-username">Email</label>
                                        <input name="Email" type="text" id="txtEmail" placeholder="Email" class="form-username form-control" required="" />
			                        </div>
									<div class="form-group">

										<label class="sr-only" for="form-username">Date</label>
                                        <input name="edate" type="Date" id="txtDate" placeholder="Date" class="form-username form-control" required="" />
			                        </div>					 
								<div class="form-group">

										<label class="sr-only" for="form-username">Place</label>
                                        <input name="Place" type="text" id="txtPlace" placeholder="Place" class="form-username form-control" required="" />
			                        </div>	
			          <div class="form-group">

										<label class="sr-only" for="form-username">GSM</label>
                                        <input name="GSM" type="number" id="txtGSM" placeholder="GSM" class="form-username form-control" required="" />
			                        </div>	
			          
  <div class="form-group">
										<label class="sr-only" for="form-username">About_fest</label>
                                        <input name="About_fest" type="textarea row=20 cols=30" id="txtAbout_fest" placeholder="About_fest" class="form-username form-control" required="" />
			                        </div>
									 <div class="form-group">
										<label class="sr-only" for="form-username">Fest_type</label>
                                        <input name="Fest_type" type="textarea row=20 cols=30" id="txtFest_type" placeholder="Fest_type" class="form-username form-control" required="" />
			                        </div>
 ...
 <th>Fest_college</th>
 <td>
 <select name="Fest_college" required>
 <option value="" selected="selected" disabled="disabled" >Select your college</option>
 <option value="Higher College of Technology">Higher College of Technology</option>
 <option value="Salalah College of Technology">Salalah College of Technology </option>
  <option value="Ibri College of Technology">Ibri College of Technology  </option>
  <option value="Shinas College of Technology">Shinas College of Technology  </option>
  <option value="Al Mussana College of Technology">Al Mussana College of Technology  </option>
  <option value="Ibra College of Technology">Ibra College of Technology </option>
  <option value="Nizwa College of Technology">Nizwa College of Technology </option>
...
<th>Department</th>
 ...
 <option value="Engineering Department">Engineering Department </option>
  <option value="Business Department">Business Department  </option>
                ...
                <a href="event_registeration2.php" class="btn btn-danger">Cancel</a> 
