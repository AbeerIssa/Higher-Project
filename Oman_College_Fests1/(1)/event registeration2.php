                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
							...
							<div class="form-group">
									...
									<div class="form-group">
										...
										<label class="sr-only" for="form-username">Fest_name</label>
                                        <input name="txtUsername" type="text" id="txtUsername" placeholder="Fest name" class="form-username form-control" required="" />
			                        </div>
<div class="form-group">
										<label class="sr-only" for="form-username">Email</label>
                                        <input name="txtUsername" type="text" id="txtUsername" placeholder="Email" class="form-username form-control" required="" />
			                        </div>
									<div class="form-group">

										<label class="sr-only" for="form-username">Date</label>
                                        <input name="txtUsername" type="text" id="txtUsername" placeholder="Date" class="form-username form-control" required="" />
			                        </div>					 
								<div class="form-group">

										<label class="sr-only" for="form-username">	Place</label>
                                        <input name="txtUsername" type="text" id="txtUsername" placeholder="Place" class="form-username form-control" required="" />
			                        </div>	
			          <div class="form-group">

										<label class="sr-only" for="form-username">	GSM</label>
                                        <input name="txtUsername" type="number" id="txtUsername" placeholder="GSM" class="form-username form-control" required="" />
			                        </div>	
			          
  <div class="form-group">
										<label class="sr-only" for="form-username">About_fest</label>
                                        <input name="txtUsername" type="text" id="txtUsername" placeholder="About_fest" class="form-username form-control" required="" />
			                        </div>
 ...
 <option value="1">Higher College of Technology</option>
 <option value="2">Salalah College of Technology </option>
  <option value="2">Ibri College of Technology  </option>
  <option value="2">Shinas College of Technology  </option>
  <option value="2">Al Mussana College of Technology  </option>
  <option value="2">Ibra College of Technology </option>
  <option value="2">Nizwa College of Technology </option>
...
<th>Department</th>
 ...
 <option value="1">I.T. Department</option>
 <option value="2">Engineering Department </option>
  <option value="2">Business Department  </option>
                ...
                <input type="submit" name="btnLogin2" value="Submit" id="btnLogin22" tabindex="4" class="btn btn-danger" />
                <a href="./user_registration.html" class="btn btn-danger">Cancel</a> 
                <small> </small> 
                <p>&nbsp;</p>
                                <div id="toggleText" style="display: none; padding: 0px;">Call Helpdesk at 947 or Network Support at 946<br />from 8:00am - 8:00pm Sunday to Wednesday<br />8:00am - 3:00pm Thursday</div>    
                        ...
                        */
                         ...
                         #social-em:hover {
                            ...
                            <div class="text-center center-block">
                                <a href="https://twitter.com/ICT_Ibra" target=_blank><i id="social-tw" class="fa fa-twitter-square fa-5x social"></i></a>
                                <a href="https://www.facebook.com/ICT.IBRA/" target=_blank><i id="social-fb" class="fa fa-facebook-square fa-5x social"></i></a>
                                <a href="https://www.instagram.com/ICT_Official/" target=_blank><i id="social-ins" class="fa fa-instagram fa-5x social"></i></a>
                                <a href="https://www.youtube.com/user/ibracollege" target=_blank><i id="social-yt" class="fa fa-youtube-square fa-5x social"></i></a>
	                            <a href="mailto:eddie@ict.edu.om"><i id="social-em" class="fa fa-envelope-square fa-5x social"></i></a>
                            </div>
