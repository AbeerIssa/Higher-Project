...
//]]>
        ...
        <div>  <a href="index.php" ><img data-u="image" src="images/banner.jpg" alt="banner" width="1920px" height="250px"/></a> </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
                             ...
                             <input type="submit" name="btnLogin2" value="Login" id="btnLogin2" tabindex="5" class="btn btn-primary" />
                               <a href=user_reg1.php> <input  type="button"   name="btnLogin3" value="New User"   id="btnLogin3" tabindex="5" class="btn btn-danger" /> 
