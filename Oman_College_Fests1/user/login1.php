...
//]]>
        ...
        <div>  <a href="index.html" ><img data-u="image" src="images/banner.jpg" alt="banner" width="1920px" height="250px"/></a> </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h4 style='font-family: courier; color: red;'>Login to our site</h4>
                            ...
                            <div class="form-bottom">
                             ...
                             <input type="submit" name="btnLogin2" value="Login" id="btnLogin2" tabindex="5" class="btn btn-primary" />
                               <a href=user_reg.html> <input  type="button"   name="btnLogin3" value="New User"   id="btnLogin3" tabindex="5" class="btn btn-danger" /> 
								
                                <p><a href=forget_pwd.html>Forgot your password?</a></p>
