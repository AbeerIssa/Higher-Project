...
<body>
<div>  <a href="search_by_college.php" ><img data-u="image" src="images/banner.jpg" alt="banner" width="1920px" height="250px"/></a> </div>
 <div class="container">
      
        
		<?php
		$cnt=1;
		$sql = "SELECT  * FROM event  WHERE fest_college =  'Al-Musanna College of Technology' ";
