...
<body>
<div>  <a href="serch_by_depatment.php" ><img data-u="image" src="images/banner.jpg" alt="banner" width="1920px" height="250px"/></a> </div>
 <div class="container">
      
        
		<?php
		$cnt=1;
		$sql = "SELECT  * FROM event  WHERE department =  'Business Studies' ";
