...
<body>
    <form method="post" action="Search_by_Date1.php" id="form1">
...
//]]>
        ...
        <div class="top-content">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
							...
							<div class="form-group">
										...
										<label class="sr-only" for="form-username">edate</label>
                                        <input  type="date" date-data-format="YYYY-MM-DD" name="txtDate"  id="txtDate" placeholder="YYYY-MM-DD" class="form-username form-control" required="" />
                ...
                <a href="Search_by_Date.php" class="btn btn-danger">Cancel</a> 
